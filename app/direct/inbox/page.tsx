          ...
          {currentUser && (
            ...
            >
              <div className="relative">
                ...
                <Avatar src={currentUser.avatar} name={currentUser.username} className="w-12 h-12 border-2 border-zinc-200 dark:border-zinc-800 group-hover:scale-105 transition" alt="Your note" />
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setShowCreateNoteModal(false)}>
          ...
          >
            ...
            <div className="p-5 flex flex-col gap-4">
              <div className="flex items-center gap-3">
                <Avatar src={currentUser.avatar} name={currentUser.username} className="w-10 h-10" />
